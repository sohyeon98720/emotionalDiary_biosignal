                ...
                switch(msg.what) {
                    case MSG_CONNECT_DEVICE:
                        ...
                        if(mConnectionState == BiosignalManager.STATE_DISCONNECTED) {
                            ...
                            service.connect(startRMData.getUniqueId(), address, new com.example.sohyeon.emotionaldiary.biosignal.service.Callback(msg.replyTo));
                        } else {
                    ...
                    case MSG_SIGNALING_START:
                        ...
                        if(mConnectionState == BiosignalManager.STATE_CONNECTED) {
                            service.startSignaling(startRMData.getUniqueId(), new com.example.sohyeon.emotionaldiary.biosignal.service.Callback(msg.replyTo));
                        }
                        break;
