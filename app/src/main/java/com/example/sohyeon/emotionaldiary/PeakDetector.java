...
public class PeakDetector {
        ...
        public int[] process(final int windowSize, final double stringency) {
            ...
            for (int i = 0; i < peakLocations.size()-1; i++) {
            	removeClose(peakLocations, toPrune, windowSize, i, i+1);
                ...
                if (peak2 - peak1 < windowSize) {
                	...
                	//System.out.println("remove " + weakerPeak);
                }*/
            }
        ...
        private void removeClose(ArrayList<Integer> peakLocations, ArrayList<Integer> toPrune, int windowSize, int i, int j) {
        	int peak1, peak2, weakerPeak;
        	try {
        		peak1 = peakLocations.get(i);
        		peak2 = peakLocations.get(j);
	        	...
	        	if (peak2 - peak1 < windowSize) {
	            	...
	            	// next
	            	removeClose(peakLocations, toPrune, windowSize, i, j+1);
	            }
