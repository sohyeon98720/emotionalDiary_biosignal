...
<img src="https://user-images.githubusercontent.com/47767202/80185706-bf63a500-8647-11ea-96a1-c721d10b09d0.png" width="30%">
  1. 위와 같은 화면을 약 1분간 바라보게 하는 방식으로 피험자들의 NEUTRAL한 상태를 측정   <br>                            
  2. HAPPY, SAD, ANGRY, CALM, 이 각각의 감성을 유발할 수 있는 영상을 1분동안 피험자가 시청하게 하여 이 때의 심박데이터 측정(_각 영상 사이에 위 그림을 바라보게 하여 앞서 시청한 영상이 다음 영상에서의 감성 유발에 영향을 끼치지 않도록 함_)           
